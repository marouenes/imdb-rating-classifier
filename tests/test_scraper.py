...
from imdb_rating_classifier.scraper.impl import Scraper

# from testing.fixtures import load_movies_data  # imported but unused
...
def test_scraper_with_some_movies(load_movies_data: dict) -> None:
    """
